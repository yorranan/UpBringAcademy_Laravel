   ...
   <div class="container">
      ...
      <div class="agileinfo-blog-grids">
         <div class="col-md-4 wthree-blog">
            <div class="w3-agileits-blog">
               <div class="w3-agileits-blog-img">
                  <a><img src="{{ asset('/images/controleClima.jpg') }}" alt="Controle Clima"/></a>
               </div>
               <div class="w3-agileits-blog-text">
                  ...
                  <p>Sistema tem incluso um controle de clima, aonde pode buscar por dados
                     ...
                     é realizado diversas análises de acumulo de graus e possiveis doenças.
                  </p>
               </div>
            </div>
         </div>
         ...
         <div class="col-md-4 wthree-blog">
            <div class="w3-agileits-blog">
               <div class="w3-agileits-blog-img">
                  <a><img src="{{ asset('/images/doencaUva.jpg') }}" alt="Doença Uva"/></a>
               </div>
               <div class="w3-agileits-blog-text">
         ...
         <div class="col-md-4 wthree-blog">
            <div class="w3-agileits-blog">
               <div class="w3-agileits-blog-img">
                  <a><img src="{{ asset('/images/relatorios.jpg') }}" alt="Relatórios"/></a>
               </div>
               <div class="w3-agileits-blog-text">
